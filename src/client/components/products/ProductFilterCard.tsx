...
const categroyList = [
	{
		...
		subCategories: ["Sábanas Ajustables", "Toallas", "Otros"],
	},
	{
		title: "Acolchados",
	},
...
const brandList = ["Duvet", "Oregon", "Baars", "Bukks", "Luasis"];
const otherOptions = ["En Liquidación", "Discontinuados", "Destacados", "Ofertas"];
const colorList = [
	"#1C1C1C",
	"#FF7A7A",
	"#FFC672",
